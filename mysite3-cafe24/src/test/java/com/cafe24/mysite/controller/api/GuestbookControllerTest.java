...
$ = 
{
	...
	"message": null,
	"data": [
		{"no": 1, "name": "user1", "password": "1234","contents": "test1", "regDate","2019-07-10 09:20"},
		{"no": 2, "name": "user2", "password": "1234","contents": "test2", "regDate","2019-07-10 09:22"}
	]
}
*/
	@Test
	public void testFetchGuestbookList() throws Exception{
		ResultActions resultActions =
				mockMvc
				.perform(get("/api/guestbook/list/10", 1L).contentType(MediaType.APPLICATION_JSON));
...
//		Mockito.when(voMockgetNo2()).thenReturn(10L);
...
//		Boolean isSuccess = mailSender.sendMail("");
